      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        >
          <div className="glass-card p-6 sm:p-8 rounded-3xl relative overflow-hidden">
            ...
            <p className="text-base sm:text-lg text-slate-700 dark:text-slate-200 leading-relaxed font-sans font-medium">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center group-hover:scale-105 transition-transform">
                    {iconMap[pillar.icon]}
                  </div>
              ...
              {/* Skill Tags */}
              <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-white/5 flex flex-wrap gap-1.5">
                {pillar.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-2 py-0.5 rounded-md text-[10px] font-mono bg-slate-200/60 dark:bg-white/5 text-slate-700 dark:text-slate-300"
                  >
                    {tag}
                  </span>
                ))}
